package util
{
   ...
   public class SkinEvent extends Event
   {
	  ...
	  public static const SKIN_DANMU_SEND:String = "danmusend";
	  
      public static const SKIN_PROGRESS_ADJUST_COMPLETE:String = "progressAdjustComplete";
      

      public static const SKIN_INTERACTIVE_TOOL_ITEM_SELECTE:String = "itemSelecte";
      public static const SKIN_INTERACTIVE_TOOL_THUMBNAIL_SELECTE:String = "thumbnailSelecte";
      public static const SKIN_INTERACTIVE_TOOL_DO_NEXT:String = "doNext";
